...
def test_history_has_opinion_request_handles_multiple_agents_and_objects():
    ...
    assert _history_has_opinion_request(history, target_agent='neo', source_agent='anima', message_id='assistant-1')
    assert _history_has_opinion_request(history, target_agent='nexus', source_agent='anima', message_id='assistant-1')
    assert not _history_has_opinion_request(history, target_agent='anima', source_agent='anima', message_id='assistant-1')
    assert not _history_has_opinion_request(history, target_agent='nexus', source_agent='neo', message_id='assistant-1')
    ...
    assert _history_has_opinion_request(history, target_agent='anima', source_agent='', message_id='assistant-2')
