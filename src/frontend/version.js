...
export const PATCH_NOTES = [
  {
    ...
    date: '2025-11-23',
    changes: [
      { type: 'fix', text: 'Bump version PWA pour invalider les caches SW et appliquer les derniers styles (RAG/TTS, mobile) sans vidage manuel.' },
      { type: 'quality', text: 'Le SW est servi en /sw.js?v=beta-3.3.38 et purge les caches emergence-shell/runtime précédents.' }
    ]
  },
  {
    version: 'beta-3.3.37',
