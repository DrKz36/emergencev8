    ...
    def parse(self, filepath: str) -> str:
        try:
            ...
            if not full_text.strip():
                logger.warning(f"Le fichier PDF '{filepath}' ne contient aucun texte extractible.")
                return ""
            return full_text
...
class ParserFactory:
    ...
    def __init__(self):
        ...
        logger.info(f"ParserFactory initialisée avec les parseurs : {list(self._parsers.keys())}")
